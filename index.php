...
<head>
  ...
  <title>Panel Login - Aplikasi Persediaan Barang TWC</title>
...
<form id="login" method="post" action="cekLogin.php">
    ...
    <fieldset id="actions">
    <button class="btn btn-theme btn-block" href="index.html" id="submit" type="submit"><i class="fa fa-lock"></i> MASUK </button>
